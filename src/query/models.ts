...
const KIND_OPTIONS = [
  ...
  { value: "production_receipt", label: "Receive from Production" },
];
...
const cellFields: FieldDef[] = [
  ...
  { name: "warehouseCode", label: "WH", type: "text", sortable: true, groupable: true, width: 70 },
  {
    ...
    type: "selection",
    options: [
      { value: "RAW", label: "Raw Material Section" },
      { value: "FG", label: "Packed Tea / FG Section" },
    ],
    sortable: true,
    groupable: true,
    width: 110,
...
const operationFilters: FilterDef[] = [
  ...
  { id: "delivery", label: "Deliveries", group: "kind", domain: cond("kind", "eq", "delivery") },
  {
    ...
    group: "kind",
    domain: cond("kind", "eq", "production_issue"),
  },
  {
    id: "prod_receipt",
    label: "Receipts from Production",
    group: "kind",
    domain: cond("kind", "eq", "production_receipt"),
  },
...
export const MODELS: Record<string, ModelDef> = {
  cell: {
    ...
    filters: cellFilters,
    groupBys: ["sectionCode", "warehouseCode", "aisleCode", "rackCode", "bay", "level", "status", "palletStatus", "materialGroup", "productName", "lotName", "ageBucket", "storageCategoryName", "rackProfile"],
  ...
  stock: {
    ...
    groupBys: ["sectionCode", "warehouseCode", "aisleCode", "rackCode", "bay", "level", "productName", "categoryName", "variantName", "lotName", "palletName", "materialGroup", "ageBucket", "uom", "inDate:month"],
  ...
  rack: {
    ...
    filters: rackFilters,
    groupBys: ["sectionCode", "warehouseCode", "aisleCode", "profileCode", "side", "materialGroup"],
